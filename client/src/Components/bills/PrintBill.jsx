            ...
            <div className="bill-details">
              ...
              <div className="grid sm:grid-cols-4 grid-cols-3 gap-12">
                <div className="text-md text-slate-500">
                  <p className="font-bold text-slate-700">Faktura Detalı:</p>
                  <p>Unwrapped</p>
                  <p> Fake Street 123</p>
                  <p> San Javier </p>
                  <p> CA 1234</p>
                ...
                <div className="text-md text-slate-500">
                  <div>
                    <p className="font-bold text-slate-700">Faktura nömrəsı:</p>
                ...
                <div className="text-md text-slate-500 sm:block hidden">
                  <div>
                    <p className="font-bold text-slate-700">Şərtlar:</p>
                    <p>10 gün</p>
                  </div>
                  <div>
                    <p className="font-bold text-slate-700 mt-2">Vadə:</p>
                    <p>2023-11-21</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bill-table-area mt-8">
                ...
                <tfoot>
                  ...
                  <tr>
                    ...
                    <th
                      ...
                      colSpan="4"
                    >
                      <p className="font-normal text-slate-700">Ümumi Toplam</p>
                    </th>
                    <th className="text-right pt-4" scope="row">
              ...
              <div className="py-9">
                <div className="border-t pt-9 border-slate-200">
                  ...
                  Ödəniş müddəti 14 gündür. Gec Qablaşdırılmamış Borclar
                    Ödəniş Aktı 0000-a əsasən, frilanserlər bu müddətdən azaddırlar.
                    00:00-dan sonra borcların ödənilməməsi halında gecikmə haqqı
                    tələb etmək hüququna sahib olduqlarını və bu nöqtədə
                    Nəzərə alın ki, əlavə olaraq yeni faktura təqdim olunacaq.
                    Yenidən işlənmiş hesab-faktura 14 gün ərzində ödənilmədikdə, ödəmə tarixi
                    əvvəlki hesab üzrə əlavə faiz və 8% qanunla müəyyən edilmiş faiz dərəcəsi üstəgəl 0,5%
                    İngiltərə bazası da daxil olmaqla cəmi 8,5% tətbiq olunacaq.
                    Tərəflər Qanunun müddəalarından başqa müqavilə bağlaya bilməzlər.
                  </p>
                </div>
              </div>
            </div>
