import { Button, Form,Carousel, Input, message } from "antd";
          ...
          <Form layout="vertical" onFinish={onFinish}>
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "İstifadəçi Adı Sahəsi Boş Olmaz!",
                },
              ]}
            >
              <Input />
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Şifrə Sahəsi Boş Olmaz!",
                },
              ]}
            >
              <Input.Password />
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Şifrə Tekrar Sahəsi Boş Olmaz!",
                },
                ({ getFieldValue }) => ({
                  validator(_, value) {
